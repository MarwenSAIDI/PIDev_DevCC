                ...
                (texttype.getText().isEmpty()))
{
         ...
         Recommandation e=new Recommandation (textid.getText(),texttitre.getText(),textdescription.getText(),textecrivain.getText(),textimage.getText(),texttype.getText(),"attente");
