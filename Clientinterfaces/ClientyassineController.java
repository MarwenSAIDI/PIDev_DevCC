 ...
 * @author yassi
 */
public class ClientyassineController implements Initializable {
...
Servicerecommandation cs = new Servicerecommandation();
        ...
        try {
            for (int i = 0; i < recommandationssarticle.size(); i++) {
                ...
                GridPane.setMargin(anchorPane, new Insets(10));
                        ...
                        Logger.getLogger(ClientyassineController.class.getName()).log(Level.SEVERE, null, e);
 ...
 deconnexion.getScene().setRoot(root);}
    ...
    private void afficherlivre(MouseEvent event) throws IOException {
         FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("clientyassinelivre.fxml"));
